 ...
 *
 * $Id: pal_types.h 37384 2015-05-13 15:50:01Z uwalter $
 *
...
#    define ATSAM4S16C                 (0x01)
#    define ATSAM4S16B                 (0x02)
#    define ATSAM4SD16C                (0x03)
#    define ATSAM4LC4CA                (0x04)
#    define ATSAM4SD32C                (0x05)
#    define ATSAM4E16E                 (0x06)

#elif (PAL_GENERIC_TYPE == SAMR)
#    define ATSAMR21G18A               (0x01)
...
#    endif
#    if (PAL_TYPE == ATMEGA64RFR2_SIM)
#        define __ATMEGA64RFR2__       (ATMEGA64RFR2)
#    endif
#elif (PAL_GENERIC_TYPE == IMX6SX) 
#		define __IMX6SX__       		(IMX6SX)
#else
