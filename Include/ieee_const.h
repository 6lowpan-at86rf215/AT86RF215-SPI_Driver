 ...
 *
 * $Id: ieee_const.h 37111 2015-03-30 10:46:26Z sschneid $
 *
...
#       define macAckWaitDuration_def \
    ((ACTIVE_TRX == RF24) ? 54 : \
     (tal_pib[ACTIVE_TRX].CurrentPage == 0 ? 120 : 54))
...
#elif (RF_BAND == BAND_MULTIPLE)
#   ifdef ACTIVE_TRX
/* O-QPSK 2.4 GHz; BPSK 900 MHz */
#    define macMaxFrameTotalWaitTime_def \
    ((ACTIVE_TRX == RF24) ? 1986 : \
     (tal_pib[ACTIVE_TRX].CurrentPage == 0 ? 2784 : 1986))
#   endif   /* #ifdef ACTIVE_TRX */
...
/*
 * Channel number boundary for scanning.
 */
#if (RF_BAND == BAND_MULTIPLE)
#   define MIN_CHANNEL(trx_id)          ((tal_pib[trx_id].SupportedChannels) & 0xFF)
#   define MAX_CHANNEL(trx_id)          (((tal_pib[trx_id].SupportedChannels) >> 16) & 0xFF)
#else
#   if (RF_BAND == BAND_2400)
#       define MIN_CHANNEL(trx_id)      (11)
#       define MAX_CHANNEL(trx_id)      (26)
#   else
#       define MIN_CHANNEL(trx_id)      (0)
#       define MAX_CHANNEL(trx_id)      (10)
#   endif
#endif
 ...
 */
#ifdef MAC_2014
#   define PL_POS_DST_PAN_ID_START          (3)
#else
 ...
 */
#ifdef MAC_2014
#   define PL_POS_DST_ADDR_START            (5)
#else
